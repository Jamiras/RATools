...
namespace RATools.Parser.Tests.Functions
{
    ...
    class RepeatedFunctionTests
    {
        ...
        [TestCase("repeated(23, ((byte(0x1234) == 1 && byte(0x2345) == 2) || byte(0x3456) == 3) && never(byte(0x4567) == 4 && byte(0x5678) == 5))",
        ...
        [TestCase("repeated(5, 6+2)", "integer")] // numeric
        [TestCase("repeated(5, byte(0x1234))", "memory accessor")] // no comparison
