...
namespace RATools.Test.Parser
{
    ...
    class AchievementScriptInterpreterTests
    {
        ...
        [TestCase("byte(0x1235) + word(0x1234) * 10 == 10000", true, "(word(0x001234) * 10 + byte(0x001235)) == 10000")]
        [TestCase("word(0x1234) * 10 + byte(0x1235) * 2 == 10000", true, "(word(0x001234) * 10 + byte(0x001235) * 2 + 0) == 10000")]
