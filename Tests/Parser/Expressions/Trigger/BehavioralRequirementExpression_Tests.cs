...
namespace RATools.Parser.Tests.Expressions.Trigger
{
    ...
    class BehavioralRequirementExpressionTests
    {
        ...
        [Test]
        [TestCase("never(6+2)", "integer")] // numeric
        [TestCase("never(byte(0x1234))", "memory accessor")] // no comparison
        [TestCase("never(f)", "variable")] // function reference
        [TestCase("unless(6+2)", "integer")] // numeric
        [TestCase("unless(byte(0x1234))", "memory accessor")] // no comparison
        [TestCase("unless(f)", "variable")] // function reference
        [TestCase("trigger_when(6+2)", "integer")] // numeric
        [TestCase("trigger_when(byte(0x1234))", "memory accessor")] // no comparison
