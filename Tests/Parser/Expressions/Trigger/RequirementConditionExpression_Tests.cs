...
namespace RATools.Parser.Tests.Expressions.Trigger
{
    ...
    class RequirementConditionExpressionTests
    {
        ...
        [TestCase("word(dword(0x7f6f10) + 0xB00) == word(dword(0x7f6f12) + 0xB02))", "I:0xX7f6f12_B:0x 000b02_I:0xX7f6f10_0x 000b00=0")] // cannot share addaddress if address differs
        [TestCase("word(dword(0x7f6f10) + 0xB00) > word(0x001234))", "I:0xX7f6f10_A:0x 000b00_0>0x 001234")] // comparing pointer read to static memory read; need extra condition to prevent pointer being applied to static address
